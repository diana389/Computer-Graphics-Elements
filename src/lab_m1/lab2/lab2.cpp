...
void Lab2::Init()
{
...

    {
        ...
        meshes["tetra_A"] = new Mesh("generated tetrahedron");
        meshes["tetra_A"]->InitFromData(vertices, indices);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0.f, 0.f, 0.f), glm::vec3(0.25f));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetra_B"], shaders["VertexColor"], glm::vec3(3.f, 0.5f, 0.f), glm::vec3(0.25f));

    // TODO(student): Draw the square
    RenderMesh(meshes["square_B"], shaders["VertexColor"], glm::vec3(2.f, 0.5f, -0.5f), glm::vec3(0.25f));
